/*  
	...
	1467623	    665.0	   665.0		  LIVE
	1479722	  1,080.46	     0.46		  LIVE
	....
	2831216	 -1,310.18	   255.25	    WEEKLY
	2768978		  0.0	   202.36		WEEKLY
	...
	2167672	   -427.67	 9,184.62	  BIWEEKLY
	2676620	      0.0	 1,184.76	  BIWEEKLY
*/
...
GROUP BY lap."login", lap.equity_eur
ORDER BY 2;
